...
export default function Home() {
  ...
  return (
    <div className="bg-[#F9FAFF] absolute w-screen h-screen -z-40 ">
      <div className="absolute -z-10 flex flex-row">

        <div className="w-[50vw] bgblue h-[450px] "></div>
        <div className="w-[50vw] bg-[#F1F5FE] h-[450px]"></div>
      </div>
      <main className="w-screen circles bg-center bg-no-repeat flex flex-col items-center h-screen">
        <div>
        ...
        <div className="h-[480px] shadow-lg w-[330px] lg:w-[540px] lg:h-[400px] mt-[70px] lg:mt-[92px] rounded-lg flex flex-col items-center bg-white ">
